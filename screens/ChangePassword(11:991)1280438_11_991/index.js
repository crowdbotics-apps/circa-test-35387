    ...
    >
      ...
      <View style={styles.View_11_992}>
        <View style={styles.View_11_993}>
          ...
          <View style={styles.View_I11_993_474_103}>
            <Text style={styles.Text_I11_993_474_103}>Old Password</Text>
          </View>
        ...
        <View style={styles.View_48_509}>
          <View style={styles.View_I48_509_474_101} />
          <View style={styles.View_I48_509_474_102}>
            <Text style={styles.Text_I48_509_474_102}>123456789</Text>
          </View>
          <View style={styles.View_I48_509_474_103}>
            <Text style={styles.Text_I48_509_474_103}>New Password</Text>
          </View>
          <View style={styles.View_I48_509_474_111}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/4547/472b/99eb50d57739ff76ab15c33675f64527"
              }}
              style={styles.ImageBackground_I48_509_474_111_137_646}
            />
          </View>
        </View>
      ...
      <View style={styles.View_11_996}>
        ...
        <View style={styles.View_I11_996_306_1385}>
          <Text style={styles.Text_I11_996_306_1385}>Save</Text>
        </View>
      </View>
      <View style={styles.View_49_272}>
        <View style={styles.View_I49_272_228_176}>
          <Text style={styles.Text_I49_272_228_176}>Change Password</Text>
        </View>
        <View style={styles.View_I49_272_228_177}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/ba30/b758/2150ad9262068f872f9328883a5e36c8"
            }}
            style={styles.ImageBackground_I49_272_228_177_154_460}
          />
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  ImageBackground_I48_509_474_111_137_646: {
    flexGrow: 1,
    width: wp("6%"),
    height: hp("2%"),
    marginLeft: 0,
  ...
  ImageBackground_I49_272_228_177_154_460: {
    flexGrow: 1,
    width: wp("2%"),
    height: hp("3%"),
    marginLeft: 0,
